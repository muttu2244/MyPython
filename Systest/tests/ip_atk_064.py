...
HOW TO RUN:python2.5 ip_atk_064.py
...
class test_ip_atk_064(test_case):
    myLog = getLogger()	
	...
	#TCP Null Scan
	out = self.linux1.cmd("sudo /usr/bin/nmap -sN %s  & "%(script_var['ssx_ip_addr']))
	time.sleep(30)
