...
DESCRIPTION:Twinge programme sends a large number of false ICMP control messages very rapidly.

TEST PLAN:IP-ATTACK test plans
TEST CASEID:ip_atk_049
...
HOW TO RUN:python2.5 ip_atk_049.py
...
class test_ip_atk_049(test_case):
    myLog = getLogger()	
	...
	out = self.linux1.cmd("sudo ./twinge %s 0 &"%script_var['ssx_ip_addr'])
        time.sleep(30)

	#killing hping process
        self.linux1.cmd("sudo pkill -9 twinge") 
