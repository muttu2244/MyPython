...
DESCRIPTION: Send flood of TCP SYN packets to SSX.
TEST PLAN:IP-ATTACK test plans
TEST CASEID:ip_atk_040
...
HOW TO RUN:python2.5 ip_atk_040.py
...
class test_ip_atk_040(test_case):
    myLog = getLogger()	
	...
	self.ssx.cmd("clear ip counters ")
        ...
        #Sending flood of TCP SYN packets to SSX.
	out = self.linux1.cmd("sudo /usr/sbin/hping -S %s -p 23 --flood &"%script_var['ssx_ip_addr'],timeout = 150)
        time.sleep(40)
