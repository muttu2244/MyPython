...
DESCRIPTION:Run nmap tool onto SSX to figure out the services running and their versions
TEST PLAN:IP-ATTACK test plans
TEST CASEID:ip_atk_068
...
HOW TO RUN:python2.5 ip_atk_068.py
...
class test_ip_atk_068(test_case):
    myLog = getLogger()	
	...
	#Run nmap tool onto SSX to figure out the services running and their versions
	out = self.linux1.cmd("sudo /usr/bin/nmap -sV %s  & "%(script_var['ssx_ip_addr']))
	time.sleep(30)
