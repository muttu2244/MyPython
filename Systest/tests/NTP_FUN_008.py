...
DESCRIPTION: Verify the time on SSX by changing the time-zone from IST to UTC and vice versa
TEST PLAN: FUN Test plans
TEST CASES: NTP_FUN_008
...
HOW TO RUN:python2.5 NTP_FUN_008.py
...
class test_NTP_FUN_008(test_case):
    myLog = getLogger()
	...
	self.ssx.config_from_string(script_var['NTP_FUN_008'])
...
if __name__ == '__main__':
	...
	suite = test_suite()
	suite.addTest(test_NTP_FUN_008)
