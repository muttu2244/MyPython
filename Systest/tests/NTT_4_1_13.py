...
DESCRIPTION: System has ability to change AD value
TEST PLAN:
TEST CASES: NTT_4-1-13

HOW TO RUN: python2.5 NTT_4_1_13.py
...
class test_NTT_4_1_13(test_case):
    myLog = getLogger()
...
if __name__ == '__main__':
        ...
        log = buildLogger("NTT_4_1_13.log", debug=True,console=True)
    	#vgrp_str = "%s %s"%(topo1[0],topo1[1])
   	#vgroup_new(vgrp_str)
        suite = test_suite()
        suite.addTest(test_NTT_4_1_13)
