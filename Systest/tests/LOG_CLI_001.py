...
class test_log_cli_001_a(test_case):
    myLog = getLogger()
    ...
    def test_test_log_cli_001_a(self):
        """
        ...
        ## Testing a value of 2
        # This value is the min valid
...
class test_log_cli_001_b(test_case):
    myLog = getLogger()
    ...
    def test_test_log_cli_001_b(self):
        """
        This test verifies the legal range for the command
        "max-retention-interval" which should be 2..365
        """
        ...
        ## Testing a value of 365
        # This value is the max valid
        
        command = 'logging auto-save max-retention-interval 365'
...
if __name__ == '__main__':
    ...
    suite = test_suite()
    suite.addTest(test_log_cli_001_a)
    suite.addTest(test_log_cli_001_b)
