...
DESCRIPTION:Flood of UDP traffic before PPPOE session is established.
TEST PLAN:IP-ATTACK test plans
TEST CASEID:ip_atk_081
...
HOW TO RUN:python2.5 ip_atk_081.py
...
class test_ip_atk_081(test_case):
    myLog = getLogger()	
   ...
   #     vg_output1 = vgroup_new(topo3[:])
	...
	self.linux1.cmd("sudo /usr/sbin/hping3 -2 -p 22 %s --flood "%script_var['ssx1_ip_addr'])
        time.sleep(40)
