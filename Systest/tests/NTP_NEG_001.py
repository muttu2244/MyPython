...
DESCRIPTION: Make ntp server unreachable and check the ntp status
TEST PLAN:NTP NEG Test plans
TEST CASES: NTP_NEG_001
...
HOW TO RUN: python2.5 NTP_NEG_001.py
...
class test_NTP_NEG_001(test_case):
    myLog = getLogger()
	...
	self.ssx.config_from_string(script_var['NTP_NEG_001'])
...
if __name__ == '__main__':
	...
	suite = test_suite()
	suite.addTest(test_NTP_NEG_001)
