...
TEST CASES:ACL_FUN_034

HOW TO RUN:python2.5 ACL_FUN_034.py
...
class test_ACL_FUN_034(test_case):
	...
	# Push SSX config
	self.ssx.config_from_string(script_var['ACL_FUN_034_IN'])
	...
	self.ssx.config_from_string(script_var['ACL_FUN_034_MOD'])
        self.ssx.cmd("clear ip counters")
