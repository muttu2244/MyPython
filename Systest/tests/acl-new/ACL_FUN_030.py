...
class test_ACL_FUN_030(test_case):
    myLog = getLogger()
	...
	# Push SSX config
	self.ssx.config_from_string(script_var['ACL_FUN_030'])
	...
	# Push SSX config
        self.ssx.config_from_string(script_var['ACL_FUN_030_1'])
