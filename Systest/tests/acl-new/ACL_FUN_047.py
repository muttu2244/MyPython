...
DESCRIPTION:To verify functionality of acl when applied to an vlan enabled interface
TEST PLAN: Sanity Test plans
TEST CASES: ACL_FUN_047
TOPOLOGY DIAGRAM:
...
HOW TO RUN : python ACL_FUN_047.py
...
class test_ACL_FUN_047(test_case):
    myLog = getLogger()
	...
	# Push SSX config
	self.ssx.config_from_string(script_var['ACL_FUN_047'])
