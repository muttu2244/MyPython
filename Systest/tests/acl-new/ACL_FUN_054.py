...
DESCRIPTION:To Verify the memory taken by ACL's on SSX, after configuring the ipv4 access-lists
TEST PLAN: ACL Test plans
TEST CASES:ACL_FUN_054

HOW TO RUN:python2.5 ACL_FUN_054.py
