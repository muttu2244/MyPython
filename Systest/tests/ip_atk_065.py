...
HOW TO RUN:python2.5 ip_atk_065.py
...
class test_ip_atk_065(test_case):
    myLog = getLogger()	
	...
	#Run Xmas tree scan to SSX which turns on the FIN,URG and PUSH flags.
	out = self.linux1.cmd("sudo /usr/bin/nmap -sX %s  & "%(script_var['ssx_ip_addr']))
	time.sleep(30)
