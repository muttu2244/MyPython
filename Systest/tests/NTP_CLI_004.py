...
DESCRIPTION: Verify the configured NTP settings are saved
TEST PLAN:NTP CLI Test plans
TEST CASES: NTP_CLI_004
...
HOW TO RUN: python2.5 NTP_CLI_004.py
...
class test_NTP_CLI_004(test_case):
    myLog = getLogger()
...
if __name__ == '__main__':
	...
	suite = test_suite()
	suite.addTest(test_NTP_CLI_004)
