...
HOW TO RUN:python2.5 ip_atk_027.py
...
class test_ip_atk_027(test_case):
    myLog = getLogger()	
	...
	out = self.linux1.cmd("sudo /usr/sbin/hping -1 -a 30.1.1.1 %s -p 23 --flood &"%(script_var['ssx_ip_addr']))
        time.sleep(30)
