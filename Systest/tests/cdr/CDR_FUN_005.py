...
class test_CDR_FUN_005(test_case):
    myLog = getLogger()
	...
	self.ssx.config_from_string(script_var['CDR_FUN_005'])
        ...
        self.myLog.info("*" *50)
        self.myLog.output("TTLV files were generated instead of XML files")
        self.myLog.info("*" *50)
