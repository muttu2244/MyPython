...
class test_CDR_FUN_004(test_case):
    myLog = getLogger()
	...
	self.ssx.config_from_string(script_var['CDR_FUN_002B'])
        ...
        xml_file = self.linux.cmd("ls -rth / | grep \".xml\" " )
        asn_file = self.linux.cmd("ls -rth / | grep \".asn\" " )

        if not ttlv_file:
         self.myLog.info("TTLV FILES ARE GENERATED FOR NO CDR CONF")
        else:
         self.myLog.info("TTLV FILES ARE NOT GENERATED FOR NO CDR CONF")

        if not xml_file:
         self.myLog.info("XML FILES ARE GENERATED FOR NO CDR CONF")
        else:
         self.myLog.output("XML FILES ARE NOT GENERATED FOR NO CDR CONF")

        if not asn_file:
         self.myLog.info("ASN FILES ARE GENERATED FOR NO CDR CONF")
        else:
         self.myLog.output("ASN FILES ARE NOT GENERATED FOR NO CDR CONF")

        self.failUnless(' ' not in ttlv_file , "TTLV FILES ARE NOT GENERATED FOR NO CDR CONF")
        self.failUnless(' ' not in xml_file , "XML FILES ARE NOT GENERATED FOR NO CDR CONF")
        self.failUnless(' ' not in asn_file , "ASN FILES ARE NOT GENERATED FOR NO CDR CONF")
