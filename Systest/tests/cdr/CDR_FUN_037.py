...
DESCRIPTION:To Verify  CDR data gets uploaded in ASN.1 format to the configured server with SFTP protocol.
TEST PLAN: CDR Test plans
TEST CASES: CDR_FUN_037
...
class test_CDR_FUN_037(test_case):
    myLog = getLogger()
