...
DESCRIPTION:To Verify CDR data getting generated for a given session after switchover & it's sessiond id
TEST PLAN: CDR Test plans
TEST CASES: CDR_HA_FUN_005
...
class test_CDR_HA_FUN_005(test_case):
    myLog = getLogger()
	...
	self.linux.cmd("cd /tftpboot")
        ttl1 =  self.linux.cmd("ls -rth | grep .ttlv | tail -n -1")
