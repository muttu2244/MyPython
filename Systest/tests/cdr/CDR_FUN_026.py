...
DESCRIPTION:To Verify  CDR will not generated for no upload profile.
TEST PLAN: CDR Test plans
TEST CASES: CDR_FUN_026
...
class test_CDR_FUN_026(test_case):
    myLog = getLogger()
	...
	# Push xpress vpn config on linux
        ...
        # Push SSX config
        self.ssx.config_from_string(script_var['CDR_FUN_026'])
