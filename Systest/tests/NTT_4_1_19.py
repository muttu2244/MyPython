...
DESCRIPTION: Confirm authentication works between OSPF neighbors
TEST PLAN:
TEST CASES: NTT_4_1_19

HOW TO RUN: python2.5 NTT_4_1_19.py
...
class test_NTT_4_1_19(test_case):
    myLog = getLogger()
	...
	self.ssx1.cmd("clear ip ospf proc")
        ...
        if "99.1.1.1" not in ospf_op1:
           self.fail("Confirm authentication not works between OSPF neighbors")
...
if __name__ == '__main__':
        ...
        log = buildLogger("NTT_4_1_19.log", debug=True,console=True)
        suite = test_suite()
        suite.addTest(test_NTT_4_1_19)
