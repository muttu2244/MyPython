...
class testIt(Thread):
   ...
   def run(self):
	...
	self.ssxHandle.cmd("load configuration /hd/DoCoMo_7_5_1.cfg", timeout=12000)
	self.status = 1
...
class test_DoCoMo_7_5_1(test_case):
	...
	ssxfdList[0].ftppasswd ("copy sftp://regress@%s:%s/DoCoMo_7_5_1.cfg /hd/DoCoMo_7_5_1.cfg noconfirm"%(scriptServer,getPath),Pword="gleep7")
