...
DESCRIPTION: Verify NTP related CLI commands in a context
TEST PLAN:NTP CLI Test plans
TEST CASES: NTP_CLI_002
...
HOW TO RUN: python2.5 NTP_CLI_002.py
...
class test_NTP_CLI_002(test_case):
    myLog = getLogger()
	...
	# Push NTP configuration on NTP client
        ...
        self.ssx.config_from_string(script_var['NTP_CLI_002'])
...
if __name__ == '__main__':
	...
	suite = test_suite()
	suite.addTest(test_NTP_CLI_002)
