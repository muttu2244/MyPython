...
DESCRIPTION: Verify clock synchronization when ntp profile is configured in local context
TEST PLAN: NTP FUN Test plans
TEST CASES: NTP_FUN_022
...
HOW TO RUN:python2.5 NTP_FUN_022.py
...
class test_NTP_FUN_022(test_case):
    myLog = getLogger()
	...
	self.ssx.config_from_string(script_var['NTP_FUN_022'])
	...
	#going to sleep i.e poll time interval from 64 sec to 1240 seconds
...
if __name__ == '__main__':
	...
	suite = test_suite()
	suite.addTest(test_NTP_FUN_022)
