...
class cli_exec_tcrt(test_case):
	...
	os.system(" cli-driver.pl -l %(cli_fldr)s/tcrt_exec_%(ssx_ver)s.log  %(ssx_type)s -C traceroute -f %(drvr-data)s %(ssx_system)s " %script_var)    	
	...
	#diff_out = os.system("diff %(gldn_fldr)s/%(ssx_ver)s/gld_tcrt_exec_%(ssx_ver)s.log %(cli_fldr)s/tcrt_exec_%(ssx_ver)s.log" %script_var )	
