...
"""
DESCRIPTION             : This script will invoke "context local -> policy-map name local " on SSX CLI (Configuration mode)
REFERENCE               : SSX-CLI Test and Automation Strategy
TEST CASES              : pmap_001_pos, 
                          pmap_002_rae,
                          pmap_003_ere,
                          pmap_004_rm2,
                          pmap_005_all 
...
class cli_cntx_pmap(test_case):
	...
	os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_pmap_pos_%(ssx_ver)s.log %(ssx_type)s -i context_local::policy-map_name_local -f %(drvr-data)s -c %(ssx_system)s " %script_var)    	
	...
	#diff_out = os.system("diff %(gldn_fldr)s/%(ssx_ver)s/gld_cntx_pmap_pos_%(ssx_ver)s.log  %(cli_fldr)s/cntx_pmap_pos_%(ssx_ver)s.log" %script_var )	
    ...
    def test_pmap_002_rae(self):
        #closing SSX conection
        self.ssx.close()
  
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_pmap_rae_%(ssx_ver)s.log %(ssx_type)s -n -i context_local::policy-map_name_local -f %(drvr-data)s -c %(ssx_system)s " %script_var)
    ...
    def test_pmap_003_ere(self):
        #closing SSX connection
        self.ssx.close()
   
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_pmap_ere_%(ssx_ver)s.log %(ssx_type)s -a -i context_local::policy-map_name_local -f %(drvr-data)s -c %(ssx_system)s " %script_var)
    ...
    def test_pmap_004_rm2(self):
        #closing SSX connection
        self.ssx.close()
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_pmap_rm2_%(ssx_ver)s.log %(ssx_type)s -2 -a -i context_local::policy-map_name_local -f %(drvr-data)s -c %(ssx_system)s " %script_var)
    ...
    def test_pmap_005_all(self):
        # closing SSX connection
        self.ssx.close()
  
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_pmap_all_%(ssx_ver)s.log %(ssx_type)s -2 -a -n -i context_local::policy-map_name_local -f %(drvr-data)s -c %(ssx_system)s " %script_var)
