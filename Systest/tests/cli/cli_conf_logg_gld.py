...
class cli_conf_logg_gld(test_case):
	...
	os.system(" cli-driver.pl -l %(gldn_fldr)s/gld_logg_pos_%(ssx_ver)s.log -u %(ssx_user)s -p %(ssx_pw)s  -f %(drvr-data_log)s -c %(ssx)s " %script_var)    	
