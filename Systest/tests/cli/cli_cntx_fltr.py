...
class cli_cntx_fltr(test_case):
	...
	os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_fltr_pos_%(ssx_ver)s.log %(ssx_type)s -i context_local::filter_local -f %(drvr-data)s -c %(ssx_system)s " %script_var)    	
...
#	#diff_out = os.system("diff %(gldn_fldr)s/%(ssx_ver)s/gld_cntx_fltr_pos_%(ssx_ver)s.log  %(cli_fldr)s/cntx_fltr_pos_%(ssx_ver)s.log" %script_var )	
...
#	#self.failUnless(not diff_out ,"Test Fail due to mismatch in logs")	
    ...
    def test_fltr_002_rae(self):
        self.ssx.close()  
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_fltr_rae_%(ssx_ver)s.log %(ssx_type)s -n -i context_local::filter_local -f %(drvr-data)s -c %(ssx_system)s " %script_var)
    ...
    def test_fltr_003_ere(self):
        self.ssx.close()   
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_fltr_ere_%(ssx_ver)s.log %(ssx_type)s -a -i context_local::filter_local -f %(drvr-data)s -c %(ssx_system)s " %script_var)
    ...
    def test_fltr_004_rm2(self):
        self.ssx.close()   
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_fltr_rm2_%(ssx_ver)s.log %(ssx_type)s -2 -a -i context_local::filter_local -f %(drvr-data)s -c %(ssx_system)s " %script_var)
    ...
    def test_fltr_005_all(self):
        self.ssx.close()
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_fltr_all_%(ssx_ver)s.log %(ssx_type)s -2 -a -n -i context_local::filter_local -f %(drvr-data)s -c %(ssx_system)s " %script_var)
