...
"""
DESCRIPTION             : This script will invoke "context local -> session " on SSX CLI (Configuration mode)
REFERENCE               : SSX-CLI Test and Automation Strategy
TEST CASES              : sesn_001_pos, 
                          sesn_002_rae,
                          sesn_003_ere,
                          sesn_004_rm2,
                          sesn_005_all 
...
class cli_cntx_sesn(test_case):
	...
	os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_sesn_pos_%(ssx_ver)s.log %(ssx_type)s -i context_local -f %(drvr-data_sesn)s -c %(ssx_system)s " %script_var)    	
	...
	#diff_out = os.system("diff %(gldn_fldr)s/%(ssx_ver)s/gld_cntx_sesn_pos_%(ssx_ver)s.log  %(cli_fldr)s/cntx_sesn_pos_%(ssx_ver)s.log" %script_var )	
    ...
    def test_sesn_002_rae(self):

        #closing SSX connection
        self.ssx.close()

        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_sesn_rae_%(ssx_ver)s.log %(ssx_type)s -n -i context_local -f %(drvr-data_sesn)s -c %(ssx_system)s " %script_var)
    ...
    def test_sesn_003_ere(self):
        #closing SSX connection
        self.ssx.close() 

        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_sesn_ere_%(ssx_ver)s.log %(ssx_type)s -a -i context_local -f %(drvr-data_sesn)s -c %(ssx_system)s " %script_var)
    ...
    def test_sesn_004_rm2(self):
        #closing SSX connection
        self.ssx.close()
 
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_sesn_rm2_%(ssx_ver)s.log %(ssx_type)s -2 -a -i context_local -f %(drvr-data_sesn)s -c %(ssx_system)s " %script_var)
    ...
    def test_sesn_005_all(self):
        #closing SSX connection
        self.ssx.close()
  
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_sesn_all_%(ssx_ver)s.log %(ssx_type)s -2 -a -n -i context_local -f %(drvr-data_sesn)s -c %(ssx_system)s " %script_var)
