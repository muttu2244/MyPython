...
class cli_pos_tunl_gld(test_case):
	...
	os.system(" cli-driver.pl -l %(gldn_fldr)s/gld_tunl_pos_%(ssx_ver)s.log -u %(ssx_user)s -p %(ssx_pw)s -i tunnel_local_type_ipsec_protocol_ip44_context_local -f %(drvr-data)s -c %(ssx)s " %script_var)    	
...
if __name__ == '__main__':
    ...
    suite = test_suite()
    suite.addTest(cli_pos_tunl_gld)
