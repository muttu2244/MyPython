...
"""
DESCRIPTION             : This script will invoke "dot1q-policy name local" on SSX CLI (Configuration mode)
REFERENCE               : SSX-cli Test and Automation Strategy
TEST CASES              : dot1_001_pos,
                          dot1_002_rae,
                          dot1_003_ere,
                          dot1_004_rm2,
                          dot1_005_all
...
class cli_conf_dot1(test_case):
	...
	os.system(" cli-driver.pl -l %(cli_fldr)s/conf_dot1_pos_%(ssx_ver)s.log %(ssx_type)s -i dot1q-policy_name_local -f %(drvr-data)s -c %(ssx_system)s " %script_var)    	
	...
	diff_out = os.system("diff %(gldn_fldr)s/%(ssx_ver)s/gld_conf_dot1_pos_%(ssx_ver)s.log  %(cli_fldr)s/conf_dot1_pos_%(ssx_ver)s.log" %script_var )	
    ...
    def test_dot1_002_rae(self):
       #closing SSX connection
        self.ssx.close() 
      
       # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/conf_dot1_rae_%(ssx_ver)s.log %(ssx_type)s -n -i dot1q-policy_name_local -f %(drvr-data)s -c %(ssx_system)s " %script_var)
    ...
    def test_dot1_003_ere(self):
        #closing SSX connection
        self.ssx.close()

        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/conf_dot1_ere_%(ssx_ver)s.log %(ssx_type)s -a -i dot1q-policy_name_local -f %(drvr-data)s -c %(ssx_system)s " %script_var)
    ...
    def test_dot1_004_rm2(self):

        #closing SSX connection
        self.ssx.close()
  
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/conf_dot1_rm2_%(ssx_ver)s.log %(ssx_type)s -2 -a -i dot1q-policy_name_local -f %(drvr-data)s -c %(ssx_system)s " %script_var)
    ...
    def test_dot1_005_all(self):

        #closing SSX connection
        self.ssx.close()

        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/conf_dot1_all_%(ssx_ver)s.log %(ssx_type)s -2 -a -n -i dot1q-policy_name_local -f %(drvr-data)s -c %(ssx_system)s " %script_var)
