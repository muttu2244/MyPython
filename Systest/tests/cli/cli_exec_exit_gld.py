...
class cli_exec_exit_gld(test_case):
	...
	os.system(" cli-driver.pl -l %(gldn_fldr)s/gld_exit_exec_%(ssx_ver)s.log -u %(ssx_user)s -p %(ssx_pw)s -C exit -f %(drvr-data)s %(ssx)s " %script_var)    	
