...
class cli_pos_port_gld(test_case):
	...
	os.system(" cli-driver.pl -l %(gldn_fldr)s/gld_port_pos_%(ssx_ver)s.log -u %(ssx_user)s -p %(ssx_pw)s -i port_ethernet_2/3 -f %(drvr-data)s -c %(ssx)s " %script_var)    	
...
if __name__ == '__main__':
    ...
    suite = test_suite()
    suite.addTest(cli_pos_port_gld)
