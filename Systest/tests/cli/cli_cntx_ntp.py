...
"""
DESCRIPTION             : This script will invoke "context local -> ntp profile" on SSX CLI (Configuration mode)
...
class cli_cntx_ntp(test_case):
	...
	# Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_ntp_pos_%(ssx_ver)s.log %(ssx_type)s -i context_local::ntp_profile -f %(drvr-data)s -c %(ssx_system)s " %script_var)    	
	...
	#diff_out = os.system("diff %(gldn_fldr)s/%(ssx_ver)s/gld_cntx_ntp_pos_%(ssx_ver)s.log  %(cli_fldr)s/cntx_ntp_pos_%(ssx_ver)s.log" %script_var )	
    ...
    def test_ntp_002_rae(self):
        ...
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_ntp_rae_%(ssx_ver)s.log %(ssx_type)s -n -i context_local::ntp_profile -f %(drvr-data)s -c %(ssx_system)s " %script_var)
    ...
    def test_ntp_003_ere(self):
        ...
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_ntp_ere_%(ssx_ver)s.log %(ssx_type)s -a -i context_local::ntp_profile -f %(drvr-data)s -c %(ssx_system)s " %script_var)
    ...
    def test_ntp_004_rm2(self):
        ...
        self.ssx.close()
         ...
         # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_ntp_rm2_%(ssx_ver)s.log %(ssx_type)s -2 -a -i context_local::ntp_profile -f %(drvr-data)s -c %(ssx_system)s " %script_var)
    ...
    def test_ntp_005_all(self):
        ...
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_ntp_all_%(ssx_ver)s.log %(ssx_type)s -2 -a -n -i context_local::ntp_profile -f %(drvr-data)s -c %(ssx_system)s " %script_var)
