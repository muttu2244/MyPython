...
class cli_conf_aaa_gld(test_case):
	...
	os.system(" cli-driver.pl -l %(gldn_fldr)s/gld_aaa_conf_%(ssx_ver)s.log -u %(ssx_user)s -p %(ssx_pw)s -i aaa_global_profile -f %(drvr-data)s -c %(ssx)s " %script_var)    	
