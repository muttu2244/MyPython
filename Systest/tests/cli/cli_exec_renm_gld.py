...
class cli_exec_renm_gld(test_case):
	...
	os.system(" cli-driver.pl -l %(gldn_fldr)s/gld_renm_exec_%(ssx_ver)s.log -u %(ssx_user)s -p %(ssx_pw)s -C rename -f %(drvr-data)s %(ssx)s " %script_var)    	
