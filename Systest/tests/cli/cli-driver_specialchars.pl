        ...
        if ($opt =~ /^\<cr\>/) {
            ...
            if ($opt =~ /^SLOT\(/) {
                ...
                if (scalar(@vals) > 0) {
                    ...
                    proc_cmd_opts("$cmd 0-/^h0", $mode, $hist);
                }
                ...
                if (scalar(@vals) > 0) {
                    ...
                    proc_cmd_opts("$cmd ^j0/^h0", $mode, $hist);
                }
            } elsif ($opt =~ /^(\d+)\.\.(\d+):(\d+)\.\.(\d+)$/) {
            ...
            if (scalar(@vals) > 0) {
                ...
                proc_cmd_opts("$cmd ^j1.-1.1.1^k", $mode, $hist);
            }
            ...
            if (scalar(@vals) > 0) {
                ...
                proc_cmd_opts("$cmd ^l1.^j1.1.1^k/24", $mode, $hist);
            }
            ...
            if (scalar(@vals) > 0) {
                ...
                proc_cmd_opts("$cmd ^k1^l::1^j", $mode, $hist);
            }
        } elsif ($opt =~ /^\/n$/) {
            # ipv6 mask
            ...
            if (scalar(@vals) > 0) {
                ...
                proc_cmd_opts("$cmd /6^j4", $mode, $hist);
            }
            ...
            if (scalar(@vals) > 0) {
                ...
                proc_cmd_opts("$cmd 1::1-^j^y/64", $mode, $hist);
            }
            ...
            if (scalar(@vals) > 0) {
                ...
                proc_cmd_opts("$cmd 00^j:00^lk:11^g:^h1-1:11:11^j", $mode, $hist);
            }
        } elsif ($opt =~ /^STRING/) {
            # string
            my $max;
            ...
            if (scalar(@vals) > 0) {
                ...
                proc_cmd_opts("$cmd ^jlo-cal^k^h", $mode, $hist);
            }
        } elsif ($opt =~ /^[\w\-]+$/ || $opt =~ /^\*$/) {
            # regular keyword
