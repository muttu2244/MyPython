...
class cli_exec_copy_gld(test_case):
	...
	os.system(" cli-driver.pl -l %(gldn_fldr)s/gld_copy_exec_%(ssx_ver)s.log -u %(ssx_user)s -p %(ssx_pw)s -C copy -f %(drvr-data)s %(ssx)s " %script_var)    	
