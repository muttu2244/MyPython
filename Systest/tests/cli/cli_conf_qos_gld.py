...
class cli_pos_qos_gld(test_case):
	...
	os.system(" cli-driver.pl -l %(gldn_fldr)s/gld_qos_pos_%(ssx_ver)s.log -u %(ssx_user)s -p %(ssx_pw)s -i qos-port-profile_name_local -f %(drvr-data)s -c %(ssx)s " %script_var)    	
