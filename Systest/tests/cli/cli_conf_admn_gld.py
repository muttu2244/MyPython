...
class cli_conf_admn_gld(test_case):
	...
	os.system(" cli-driver.pl -l %(gldn_fldr)s/gld_admn_conf_%(ssx_ver)s.log -u %(ssx_user)s -p %(ssx_pw)s -i admin_global_profile -f %(drvr-data)s -c %(ssx)s " %script_var)    	
