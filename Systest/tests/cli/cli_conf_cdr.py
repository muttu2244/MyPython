...
class cli_conf_cdr(test_case):
	...
	os.system(" cli-driver.pl -l %(cli_fldr)s/conf_cdr_pos_%(ssx_ver)s.log %(ssx_type)s -i cdr -f %(drvr-data)s -c %(ssx_system)s " %script_var)    	
	...
	diff_out = os.system("diff %(gldn_fldr)s/%(ssx_ver)s/gld_conf_cdr_pos_%(ssx_ver)s.log  %(cli_fldr)s/conf_cdr_pos_%(ssx_ver)s.log" %script_var )	
    ...
    def test_cdr_002_rae(self):
        ...
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/conf_cdr_rae_%(ssx_ver)s.log %(ssx_type)s -n -i cdr -f %(drvr-data)s -c %(ssx_system)s " %script_var)
    ...
    def test_cdr_003_ere(self):
        ...
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/conf_cdr_ere_%(ssx_ver)s.log %(ssx_type)s -a -i cdr -f %(drvr-data)s -c %(ssx_system)s " %script_var)
    ...
    def test_cdr_004_rm2(self):
        ...
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/conf_cdr_rm2_%(ssx_ver)s.log %(ssx_type)s -2 -a -i cdr -f %(drvr-data)s -c %(ssx_system)s " %script_var)
    ...
    def test_cdr_005_all(self):
        ...
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/conf_cdr_all_%(ssx_ver)s.log %(ssx_type)s -2 -a -n -i cdr -f %(drvr-data)s -c %(ssx_system)s " %script_var)
