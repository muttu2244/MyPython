...
"""
DESCRIPTION             : This script will invoke "context local -> aaa profile" on SSX CLI (Configuration mode)
...
class cli_cntx_aaa(test_case):
	...
	# Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_aaa_pos_%(ssx_ver)s.log %(ssx_type)s -i context_local::aaa_profile -f %(drvr-data)s -c %(ssx_system)s " %script_var)    	
	...
	#diff_out = os.system("diff %(gldn_fldr)s/%(ssx_ver)s/gld_cntx_aaa_pos_%(ssx_ver)s.log  %(cli_fldr)s/cntx_aaa_pos_%(ssx_ver)s.log" %script_var )	
    ...
    def test_aaa_002_rae(self):
        ...
        self.ssx.close()
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_aaa_rae_%(ssx_ver)s.log %(ssx_type)s -n -i context_local::aaa_profile -f %(drvr-data)s -c %(ssx_system)s " %script_var)
    ...
    def test_aaa_003_ere(self):
        ...
        self.ssx.close()
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_aaa_ere_%(ssx_ver)s.log %(ssx_type)s -a -i context_local::aaa_profile -f %(drvr-data)s -c %(ssx_system)s " %script_var)
    ...
    def test_aaa_004_rm2(self):
        ...
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_aaa_rm2_%(ssx_ver)s.log %(ssx_type)s -2 -a -i context_local::aaa_profile -f %(drvr-data)s -c %(ssx_system)s " %script_var)
    ...
    def test_aaa_005_all(self):
        ...
        self.ssx.close()   
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_aaa_all_%(ssx_ver)s.log %(ssx_type)s -2 -a -n -i context_local::aaa_profile -f %(drvr-data)s -c %(ssx_system)s " %script_var)
