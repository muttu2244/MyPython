...
"""
DESCRIPTION             : This script will invoke "ipsec global profile" on SSX CLI (Configuration mode)
...
class cli_conf_ipsc(test_case):
	...
	os.system(" cli-driver.pl -l %(cli_fldr)s/conf_ipsc_pos_%(ssx_ver)s.log %(ssx_type)s -i ipsec_global_profile -f %(drvr-data)s -c %(ssx_system)s " %script_var)    	
	...
	diff_out = os.system("diff %(gldn_fldr)s/%(ssx_ver)s/gld_conf_ipsc_pos_%(ssx_ver)s.log  %(cli_fldr)s/conf_ipsc_pos_%(ssx_ver)s.log" %script_var )	
    ...
    def test_ipsc_002_rae(self):
      
        #closing SSX connection
        self.ssx.close() 

        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/conf_ipsc_rae_%(ssx_ver)s.log %(ssx_type)s -n -i ipsec_global_profile -f %(drvr-data)s -c %(ssx_system)s " %script_var)
    ...
    def test_ipsc_003_ere(self):
 
        #closing SSX conenction
        self.ssx.close()
 
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/conf_ipsc_ere_%(ssx_ver)s.log %(ssx_type)s -a -i ipsec_global_profile -f %(drvr-data)s -c %(ssx_system)s " %script_var)
    ...
    def test_ipsc_004_rm2(self):

        #closing SSX connection
        self.ssx.close()

        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/conf_ipsc_rm2_%(ssx_ver)s.log %(ssx_type)s -2 -a -i ipsec_global_profile -f %(drvr-data)s -c %(ssx_system)s " %script_var)
    ...
    def test_ipsc_005_all(self):

        #closing SSX connection
        self.ssx.close()
 
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/conf_ipsc_all_%(ssx_ver)s.log %(ssx_type)s -2 -a -n -i ipsec_global_profile -f %(drvr-data)s -c %(ssx_system)s " %script_var)
