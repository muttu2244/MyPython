...
class cli_pos_ntp_gld(test_case):
	...
	os.system(" cli-driver.pl -l %(gldn_fldr)s/gld_ntp_pos_%(ssx_ver)s.log -u %(ssx_user)s -p %(ssx_pw)s -i ntp-global_global_profile -f %(drvr-data)s -c %(ssx)s " %script_var)    	
