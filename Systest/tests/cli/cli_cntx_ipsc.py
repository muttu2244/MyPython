...
class cli_cntx_ipsc(test_case):
	...
	os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_ipsc_pos_%(ssx_ver)s.log %(ssx_type)s -i context_local -f %(drvr-data_ipsc)s -c %(ssx_system)s " %script_var)    	
	...
	#diff_out = os.system("diff %(gldn_fldr)s/%(ssx_ver)s/gld_cntx_ipsc_pos_%(ssx_ver)s.log  %(cli_fldr)s/cntx_ipsc_pos_%(ssx_ver)s.log" %script_var )	
    ...
    def test_ipsc_002_rae(self):
        ...
        self.ssx.close()
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_ipsc_rae_%(ssx_ver)s.log %(ssx_type)s -n -i context_local -f %(drvr-data_ipsc)s -c %(ssx_system)s " %script_var)
    ...
    def test_ipsc_003_ere(self):
        ...
        self.ssx.close()
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_ipsc_ere_%(ssx_ver)s.log %(ssx_type)s -a -i context_local -f %(drvr-data_ipsc)s -c %(ssx_system)s " %script_var)
    ...
    def test_ipsc_004_rm2(self):
        ...
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_ipsc_rm2_%(ssx_ver)s.log %(ssx_type)s -2 -a -i context_local -f %(drvr-data_ipsc)s -c %(ssx_system)s " %script_var)
        # Opening SSX Connection Again
        self.ssx = SSX(topo.ssx_con['ip_addr'])
        self.ssx.telnet()
    ...
    def test_ipsc_005_all(self):
        ...
        self.ssx.close() 
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_ipsc_all_%(ssx_ver)s.log %(ssx_type)s -2 -a -n -i context_local -f %(drvr-data_ipsc)s -c %(ssx_system)s " %script_var)
