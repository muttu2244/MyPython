...
class cli_exec_conf_gld(test_case):
	...
	os.system(" cli-driver.pl -l %(gldn_fldr)s/gld_conf_exec_%(ssx_ver)s.log -u %(ssx_user)s -p %(ssx_pw)s -C configuration -f %(drvr-data)s %(ssx)s " %script_var)    	
