...
"""
DESCRIPTION             : This script will invoke "context local -> police profile name local" on SSX CLI (Configuration mode)
REFERENCE               : SSX-CLI Test and Automation Strategy
TEST CASES              : plcy_001_pos, 
                          plcy_002_rae,
                          plcy_003_ere,
                          plcy_004_rm2,
                          plcy_005_all 
...
class cli_cntx_plcy(test_case):
	...
	# Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_plcy_pos_%(ssx_ver)s.log %(ssx_type)s -i context_local::police_profile_name_local -f %(drvr-data)s -c %(ssx_system)s " %script_var)    	
	...
	#diff_out = os.system("diff %(gldn_fldr)s/%(ssx_ver)s/gld_cntx_plcy_pos_%(ssx_ver)s.log  %(cli_fldr)s/cntx_plcy_pos_%(ssx_ver)s.log" %script_var )	
    ...
    def test_plcy_002_rae(self):
        #closing SSX connection
        self.ssx.close()
  
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_plcy_rae_%(ssx_ver)s.log %(ssx_type)s -n -i context_local::police_profile_name_local -f %(drvr-data)s -c %(ssx_system)s " %script_var)
    ...
    def test_plcy_003_ere(self):
        #closing SSX connection
        self.ssx.close()

        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_plcy_ere_%(ssx_ver)s.log %(ssx_type)s -a -i context_local::police_profile_name_local -f %(drvr-data)s -c %(ssx_system)s " %script_var)
    ...
    def test_plcy_004_rm2(self):
        #closing SSX connection
        self.ssx.close()

        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_plcy_rm2_%(ssx_ver)s.log %(ssx_type)s -2 -a -i context_local::police_profile_name_local -f %(drvr-data)s -c %(ssx_system)s " %script_var)
    ...
    def test_plcy_005_all(self):
        #closing SSX connection
        self.ssx.close()
 
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_plcy_all_%(ssx_ver)s.log %(ssx_type)s -2 -a -n -i context_local::police_profile_name_local -f %(drvr-data)s -c %(ssx_system)s " %script_var)
