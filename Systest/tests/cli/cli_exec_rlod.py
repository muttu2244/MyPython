...
class cli_exec_rlod(test_case):
	...
	os.system(" cli-driver.pl -l %(cli_fldr)s/rlod_exec_%(ssx_ver)s.log  %(ssx_type)s -C reload -f %(drvr-data)s %(ssx_system)s " %script_var)    	
	...
	#diff_out = os.system("diff %(gldn_fldr)s/%(ssx_ver)s/gld_rlod_exec_%(ssx_ver)s.log %(cli_fldr)s/rlod_exec_%(ssx_ver)s.log" %script_var )	
