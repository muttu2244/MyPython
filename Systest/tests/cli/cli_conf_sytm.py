...
class cli_conf_sytm(test_case):
	...
	os.system(" cli-driver.pl -l %(cli_fldr)s/conf_sytm_pos_%(ssx_ver)s.log %(ssx_type)s  -f %(drvr-data_sytm)s -c %(ssx_system)s " %script_var)    	
	...
	#diff_out = os.system("diff %(gldn_fldr)s/%(ssx_ver)s/gld_conf_sytm_pos_%(ssx_ver)s.log %(cli_fldr)s/conf_sytm_pos_%(ssx_ver)s.log" %script_var )	
