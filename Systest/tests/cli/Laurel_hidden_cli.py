...
DEPENDENCIES: None
How to run: "python2.5 Laurel_hidden_cli.py"
AUTHOR: Ganapathi 
REVIEWER: 
"""
...
class test_Laurel_hidden_cli(test_case):
    """ 
    Description: Runs MDO LI testcases Laurel_hidden_cli.py
    """
    my_log = getLogger()
    ...
    def setUp(self):
        ...
        self.ssx = SSX("bahamas-mc","root","stoke123")
        self.ssx.telnet()
    ...
    def test_Laurel_hidden_cli(self):
        """
        Test case Id: -  Laurel_hidden_cli,
        Description:  -  Script for verifying Laurel_hidden_cli
        """
        ...
        hidden_cmd_list7= ["port ethernet 4/3 dot1q","vlan 1300","bind interface rnc gana","ipsec policy ikev1 phase1 name ph1","ipsec policy ikev1 phase2 name ph2","exit","exit","exit"]
        ...
        hidden_cmd_list9 = ["port ethernet 4/0","bind interface gana gana","ipsec policy ikev1 phase1 name ph13","ipsec policy ikev1 phase2 name ph23","exit","exit"] 
        ...
        self.ssx.cmd("no port eth 4/3 dot1q")
        self.ssx.cmd("no port eth 4/1 dot1q")
        self.ssx.cmd("no port eth 4/0")
        self.ssx.cmd("end")
...
if __name__ == '__main__':
    ...
    suite = test_suite()
    suite.addTest(test_Laurel_hidden_cli)
