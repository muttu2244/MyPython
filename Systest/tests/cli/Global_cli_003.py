...
DEPENDENCIES: None
How to run: "python2.5 Global_cli_003.py"
AUTHOR: Ganapathi 
REVIEWER: 
"""
...
class test_Global_cli_003(test_case):
    """ 
    ...
    def test_Global_cli_003(self):
        """
        Test case Id: -  Global_cli_003,
        Description:  -  Script for verifying Global_cli_003
        """
        ...
        hidden_cmd_list7= ["port ethernet 2/0 dot1q","vlan 1300","bind interface rnc gana","ipsec policy ikev1 phase1 name ph1","ipsec policy ikev1 phase2 name ph2","exit","exit","exit"]
        ...
        self.ssx.cmd("no port eth 2/0 dot1q")
...
if __name__ == '__main__':
    ...
    suite = test_suite()
    suite.addTest(test_Global_cli_003)
