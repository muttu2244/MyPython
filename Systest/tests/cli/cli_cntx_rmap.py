...
"""
DESCRIPTION             : This script will invoke "context local -> route-map local " on SSX CLI (Configuration mode)
REFERENCE               : SSX-CLI Test and Automation Strategy
TEST CASES              : rmap_001_pos, 
                          rmap_002_rae,
                          rmap_003_ere,
                          rmap_004_rm2,
                          rmap_005_all 
...
class cli_cntx_rmap(test_case):
	...
	os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_rmap_pos_%(ssx_ver)s.log %(ssx_type)s -i context_local::route-map_local -f %(drvr-data_rmap)s -c %(ssx_system)s " %script_var)    	
	...
	#diff_out = os.system("diff %(gldn_fldr)s/%(ssx_ver)s/gld_cntx_rmap_pos_%(ssx_ver)s.log  %(cli_fldr)s/cntx_rmap_pos_%(ssx_ver)s.log" %script_var )	
    ...
    def test_rmap_002_rae(self):
        #closing SSX connection
        self.ssx.close()


        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_rmap_rae_%(ssx_ver)s.log %(ssx_type)s -n -i context_local::route-map_local -f %(drvr-data_rmap)s -c %(ssx_system)s " %script_var)
    ...
    def test_rmap_003_ere(self):
        #closing SSX connection
        self.ssx.close()
 
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_rmap_ere_%(ssx_ver)s.log %(ssx_type)s -a -i context_local::route-map_local -f %(drvr-data_rmap)s -c %(ssx_system)s " %script_var)
    ...
    def test_rmap_004_rm2(self):
        #closing SSX connection
        self.ssx.close()
 
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_rmap_rm2_%(ssx_ver)s.log %(ssx_type)s -2 -a -i context_local::route-map_local -f %(drvr-data_rmap)s -c %(ssx_system)s " %script_var)
    ...
    def test_rmap_005_all(self):
        # closing SSX connection
        self.ssx.close()

        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_rmap_all_%(ssx_ver)s.log %(ssx_type)s -2 -a -n -i context_local::route-map_local -f %(drvr-data_rmap)s -c %(ssx_system)s " %script_var)
