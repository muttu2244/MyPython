...
"""
DESCRIPTION             : This script will invoke "context local -> router" and "router-id"  on SSX CLI (Configuration mode)
REFERENCE               : SSX-CLI Test and Automation Strategy
TEST CASES              : rotr_001_pos, 
                          rotr_002_rae,
                          rotr_003_ere,
                          rotr_004_rm2,
                          rotr_005_all 
...
class cli_cntx_rotr(test_case):
	...
	os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_rotr_pos_%(ssx_ver)s.log %(ssx_type)s -i context_local -f %(drvr-data_rotr)s -c %(ssx_system)s " %script_var)    	

	
        # Comparing the log file against the golden file
	#self.myLog.output("Comparing the log files")
	#diff_out = os.system("diff %(gldn_fldr)s/%(ssx_ver)s/gld_cntx_rotr_pos_%(ssx_ver)s.log  %(cli_fldr)s/cntx_rotr_pos_%(ssx_ver)s.log" %script_var )	
    ...
    def test_rotr_002_rae(self):

        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_rotr_rae_%(ssx_ver)s.log %(ssx_type)s -n -i context_local -f %(drvr-data_rotr)s -c %(ssx_system)s " %script_var)
    ...
    def test_rotr_003_ere(self):

        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_rotr_ere_%(ssx_ver)s.log %(ssx_type)s -a -i context_local -f %(drvr-data_rotr)s -c %(ssx_system)s " %script_var)
    ...
    def test_rotr_004_rm2(self):

        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_rotr_rm2_%(ssx_ver)s.log %(ssx_type)s -2 -a -i context_local -f %(drvr-data_rotr)s -c %(ssx_system)s " %script_var)
    ...
    def test_rotr_005_all(self):

        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_rotr_all_%(ssx_ver)s.log %(ssx_type)s -2 -a -n -i context_local -f %(drvr-data_rotr)s -c %(ssx_system)s " %script_var)
