...
"""
DESCRIPTION             : This script will invoke "snmp" on SSX CLI (Configuration mode)
REFERENCE               : SSX-cli Test and Automation Strategy
TEST CASES              : snmp_001_pos,
                          snmp_002_rae,
                          snmp_003_ere,
                          snmp_004_rm2,
                          snmp_005_all
...
class cli_conf_snmp(test_case):
	...
	os.system(" cli-driver.pl -l %(cli_fldr)s/conf_snmp_pos_%(ssx_ver)s.log %(ssx_type)s  -i snmp -f %(drvr-data)s -c %(ssx_mc)s " %script_var)    	
	...
	#diff_out = os.system("diff %(gldn_fldr)s/%(ssx_ver)s/gld_conf_snmp_pos_%(ssx_ver)s.log  %(cli_fldr)s/conf_snmp_pos_%(ssx_ver)s.log" %script_var )	
    ...
    def test_snmp_002_rae(self):

        #closing SSX connection
        self.ssx.close()
   
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/conf_snmp_rae_%(ssx_ver)s.log %(ssx_type)s -n -i snmp -f %(drvr-data)s -c %(ssx_system)s " %script_var)
    ...
    def test_snmp_003_ere(self):

        #closing SSX connection
        self.ssx.close()

        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/conf_snmp_ere_%(ssx_ver)s.log %(ssx_type)s -a -i snmp -f %(drvr-data)s -c %(ssx_system)s " %script_var)
    ...
    def test_snmp_004_rm2(self):

        #closing SSX connection
        self.ssx.close()

        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/conf_snmp_rm2_%(ssx_ver)s.log %(ssx_type)s -2 -a -i snmp -f %(drvr-data)s -c %(ssx_system)s " %script_var)
    ...
    def test_snmp_005_all(self):
        ...
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/conf_snmp_all_%(ssx_ver)s.log %(ssx_type)s  -2 -a -n -i snmp -f %(drvr-data)s -c %(ssx_system)s " %script_var)
