...
class cli_pos_snmp(test_case):
	...
	os.system(" cli-driver.pl -l %(gldn_fldr)s/gld_snmp_pos_%(ssx_ver)s.log -u %(ssx_user)s -p %(ssx_pw)s -i snmp -f %(drvr-data)s -c %(ssx)s " %script_var)    	
