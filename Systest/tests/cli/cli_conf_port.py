...
"""
DESCRIPTION             : This script will invoke "port ethernet 2/3" on SSX CLI (Configuration mode)
REFERENCE               : SSX-cli Test and Automation Strategy
TEST CASES              : port_001_pos,
                          port_002_rae,
                          port_003_ere,
                          port_004_rm2,
                          port_005_all
...
class cli_conf_port(test_case):
	...
	os.system(" cli-driver.pl -l %(cli_fldr)s/conf_port_pos_%(ssx_ver)s.log %(ssx_type)s -i port_ethernet_2/3 -f %(drvr-data)s -c %(ssx_system)s " %script_var)    	
	...
	diff_out = os.system("diff %(gldn_fldr)s/%(ssx_ver)s/gld_conf_port_pos_%(ssx_ver)s.log  %(cli_fldr)s/conf_port_pos_%(ssx_ver)s.log" %script_var )	
    ...
    def test_port_002_rae(self):
        
        #closing SSX connection
        self.ssx.close()

        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/conf_port_rae_%(ssx_ver)s.log %(ssx_type)s -n -i port_ethernet_2/3 -f %(drvr-data)s -c %(ssx_system)s " %script_var)
    ...
    def test_port_003_ere(self):

        #closing SSX connection
        self.ssx.close()
 
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/conf_port_ere_%(ssx_ver)s.log %(ssx_type)s -a -i port_ethernet_2/3 -f %(drvr-data)s -c %(ssx_system)s " %script_var)
    ...
    def test_port_004_rm2(self):

        #closing SSX connection
        self.ssx.close()
 
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/conf_port_rm2_%(ssx_ver)s.log %(ssx_type)s -2 -a -i port_ethernet_2/3 -f %(drvr-data)s -c %(ssx_system)s " %script_var)
    ...
    def test_port_005_all(self):

        #closing SSX connection
        self.ssx.close()
 
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/conf_port_all_%(ssx_ver)s.log %(ssx_type)s -2 -a -n -i port_ethernet_2/3 -f %(drvr-data)s -c %(ssx_system)s " %script_var)
