...
TEST CASES:  Global_Cli_005

TOPOLOGY DIAGRAM: 

DEPENDENCIES: None
How to run: "python2.5 Global_Cli_005"
AUTHOR: Ganapathi 
REVIEWER: 
"""
...
class test_Global_Cli_005(test_case):
    """ 
    Description: Executes all show commands during an IMC switch-Over
    """
    ...
    def test_Global_Cli_005(self):
        """
        Test case Id: -  Global_Cli_005,
        Description:  -  Executes all show commands during an IMC switch-Over
        """
        switch_over = True
        for cmd in cmd_list:
            ...
            if not switch_over:                 
                ...
                switch_over = True
            if self.ssx.get_standby_imc_status():
                switch_over = False
                continue
            self.ssx.cmd(cmd)
...
if __name__ == '__main__':
    ...
    suite = test_suite()
    suite.addTest(test_Global_Cli_005)
