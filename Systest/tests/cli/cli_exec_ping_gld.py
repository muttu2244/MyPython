...
class cli_exec_ping_gld(test_case):
	...
	os.system(" cli-driver.pl -l %(gldn_fldr)s/gld_ping_exec_%(ssx_ver)s.log -u %(ssx_user)s -p %(ssx_pw)s -C ping -f %(drvr-data)s %(ssx)s " %script_var)    	
...
if __name__ == '__main__':
    ...
    suite = test_suite()
    suite.addTest(cli_exec_ping_gld)
