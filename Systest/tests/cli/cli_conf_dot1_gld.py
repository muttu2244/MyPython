...
class cli_conf_dot1_gld(test_case):
	...
	os.system(" cli-driver.pl -l %(gldn_fldr)s/gld_dot1_conf_%(ssx_ver)s.log -u %(ssx_user)s -p %(ssx_pw)s -i dot1q-policy_name_local -f %(drvr-data)s -c %(ssx)s " %script_var)    	
