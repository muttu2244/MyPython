...
class cli_pos_boot_gld(test_case):
	...
	os.system(" cli-driver.pl -l %(gldn_fldr)s/gld_boot_pos_%(ssx_ver)s.log -u %(ssx_user)s -p %(ssx_pw)s -C boot -f %(drvr-data)s %(ssx)s " %script_var)    	
...
if __name__ == '__main__':
    ...
    suite = test_suite()
    suite.addTest(cli_pos_boot_gld)
