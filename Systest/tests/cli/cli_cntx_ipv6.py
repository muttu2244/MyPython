...
class cli_cntx_ipv6(test_case):
	...
	os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_ipv6_pos_%(ssx_ver)s.log %(ssx_type)s -i context_local -f %(drvr-data_ipv6)s -c %(ssx_system)s " %script_var)    	
	...
	#diff_out = os.system("diff %(gldn_fldr)s/%(ssx_ver)s/gld_cntx_ipv6_pos_%(ssx_ver)s.log  %(cli_fldr)s/cntx_ipv6_pos_%(ssx_ver)s.log" %script_var )	
    ...
    def test_ipv6_002_rae(self):
        # closing SSX connection
        self.ssx.close()

        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_ipv6_rae_%(ssx_ver)s.log %(ssx_type)s -n -i context_local -f %(drvr-data_ipv6)s -c %(ssx_system)s " %script_var)
    ...
    def test_ipv6_003_ere(self):
        # closing SSX connection
        self.ssx.close()
 
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_ipv6_ere_%(ssx_ver)s.log %(ssx_type)s -a -i context_local -f %(drvr-data_ipv6)s -c %(ssx_system)s " %script_var)
    ...
    def test_ipv6_004_rm2(self):
        #closing SSX connection
        self.ssx.close()
   
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_ipv6_rm2_%(ssx_ver)s.log %(ssx_type)s -2 -a -i context_local -f %(drvr-data_ipv6)s -c %(ssx_system)s " %script_var)
    ...
    def test_ipv6_005_all(self):
        # closing SSX connection
        self.ssx.close()
    
        # Running the cli-driver commnad
        os.system(" cli-driver.pl -l %(cli_fldr)s/cntx_ipv6_all_%(ssx_ver)s.log %(ssx_type)s -2 -a -n -i context_local -f %(drvr-data_ipv6)s -c %(ssx_system)s " %script_var)
