...
Description: - Verify session authentication with RADIUS using valid session credentials 
TEST PLAN: AAA/RADIUS Test Plan
TEST CASES: AAA-FUN-022
...
How to run: "python2.5 AAA_FUN_022.py"
...
class test_AAA_FUN_022(test_case):
    ...
    def test_AAA_FUN_022(self):

        """
        Test case Id: -  AAA-FUN-022
        """
        ...
        self.ssx.config_from_string(script_var['fun_022_ssx'])
        ...
        self.ns5gt.config_from_string(script_var['fun_022_ns5gt'])
