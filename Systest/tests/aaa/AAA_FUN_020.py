...
Description: -   Verify that the session credentials with missing domain name are forwarded to default domain name 
TEST PLAN: AAA/RADIUS Test Plan
TEST CASES: AAA-FUN-020
...
How to run: "python2.5 AAA_FUN_020.py"
