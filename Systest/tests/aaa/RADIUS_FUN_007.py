...
Description: -   Verify the default re-tries & timeout values (3 & 10 sec.s respectively) are applied when a radius server becomes un reachable. 
...
How to run: "python2.5 RADIUS_FUN_007.py"
