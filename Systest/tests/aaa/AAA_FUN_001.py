...
Description: -  Verify User authentication with local database using valid user credentials.
TEST PLAN: AAA/RADIUS Test Plan
TEST CASES: AAA-FUN-001
TOPOLOGY DIAGRAM:
...
How to run: "python2.5 AAA_FUN_001.py"
...
class test_AAA_FUN_001(test_case):
    ...
    def test_AAA_FUN_001(self):

        """
        Test case Id: -  AAA-FUN-001
        """
	...
	time.sleep(10)
        # Initiate Telnet Session from linux Client  with valid user-2 credentials 
