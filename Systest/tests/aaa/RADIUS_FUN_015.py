...
TOPOLOGY DIAGRAM:
  ...
  (Netscreen)                          |        |                            (Linux)
   ...
   |qa-ns1 | --------------------------|        |-------------------------| qa-svr3      |
    ------                             |        |                          --------------
                                        --------
How to run: "python2.5 RADIUS_FUN_015.py"
...
class test_RADIUS_FUN_015(test_case):
    myLog = getLogger()
    ...
    def test_RADIUS_FUN_015(self):
        """
        Test case Id: -  RADIUS_FUN_015
	"""
        ...
        self.ssx.config_from_string(script_var['rad_fun_015_ssx'])

        # Push xpress vpn config
        self.xpress_vpn.write_to_file(script_var['rad_fun_015_xpressvpn'],"autoexec.cfg","/xpm/")
