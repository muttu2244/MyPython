...
Description: - Verify  session authentication with RADIUS using in-valid Phase1 authentication credentials 
TEST PLAN: AAA/RADIUS Test Plan
TEST CASES: AAA-FUN-023
...
How to run: "python2.5 AAA_FUN_023.py"
...
class test_AAA_FUN_023(test_case):
    ...
    def test_AAA_FUN_023(self):
        ...
        op_debug =  aaa_verify_authentication(self.ssx,"invaliduser@%s" %script_var['context'],"radius")
