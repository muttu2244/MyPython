...
#    test_list = [test_list[11], test_list[13], test_list[14], test_list[17],test_list[18],test_list[19],test_list[20]]
    ...
    test_indices = [0,2,7,10,18,28,35,48,67,83,97,101,105,106,112,117,126,136,139,142,144,150,162,163,167,172,180,185,189,215,228,287,298,302,305,316,321,331,387,390,392,394,415,455,463,470,473,526,1000]
    ...
    if portcfg == "same vlan":
        if not cct1.vlan_untagged:
            if cct1.ipsec and cct2.ipsec:
                ...
                vgroup_old(vlan_cfg_str,globals())
...
#	print ""
    ...
    log = buildLogger('encaps_sanity.log', debug=True, console=True)

    suite = test_suite()
    suite.addTest(encaps_sanity)
