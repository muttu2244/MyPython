...
DESCRIPTION: Define stub and confirm system only forward default route and routing for diffrerent area 
TEST PLAN:
TEST CASES: NTT_4_1_16

HOW TO RUN: python2.5 NTT_4_1_16.py
...
class test_NTT_4_1_16(test_case):
    myLog = getLogger()
...
if __name__ == '__main__':
        ...
        log = buildLogger("NTT_4_1_16.log", debug=True,console=True)
        suite = test_suite()
        suite.addTest(test_NTT_4_1_16)
