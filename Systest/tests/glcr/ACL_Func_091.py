...
DESCRIPTION: Verify ACL functionality for UDP traffic through session when inbound and outbound ACLs applied to session [Deny for inbound and Deny for outbound] 
TEST PLAN: ACL Test plans
TEST CASES:ACL_Func_091.py

HOW TO RUN:python2.5 ACL_Func_091
...
class test_ACL_Func_091(test_case):
    myLog = getLogger()
    def setUp(self):
