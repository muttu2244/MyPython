#!/usr/bin/env python2.5CL_Func_223.py
"""
#######################################################################
#
...
DESCRIPTION: Verify ACL functionality for UDP traffic through native vlan enabled port when inbound and outbound ACLs applied to native vlan enabled port [Deny for inbound and Deny for outbound]
TEST PLAN: ACL Test plans
TEST CASES:ACL_FUNC_239.py

HOW TO RUN:python2.5 ACL_FUNC_239
...
class test_ACL_FUNC_239(test_case):
    myLog = getLogger()
    def setUp(self):
