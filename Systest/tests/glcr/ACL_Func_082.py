...
DESCRIPTION: Verify ACL functionality for IGMP traffic through session when inbound and outbound ACLs applied to session [Permit for inbound and Permit for outbound] 
TEST PLAN: ACL Test plans
TEST CASES:ACL_Func_082.py

HOW TO RUN:python2.5 ACL_Func_082
...
class test_ACL_Func_082(test_case):
    myLog = getLogger()
    def setUp(self):
