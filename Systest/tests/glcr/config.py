...
script_var['radiusLoc'] = 'usr/local/sbin/'
...
script_var['active_slot2__mask'] = '17.1.1.0/24'
...
script_var['active_slot4_mask'] = '27.1.1.0/24'
...
script_var['serv_slot2_mask'] = '18.1.1.0/24'
...
script_var['serv_slot4_mask'] = '28.1.1.0/24'
...
script_var['xpIfMsk']= '11.11.11.0 255.255.255.0'
...
script_var['linux1Msk']= '22.22.22.0 255.255.255.0'
...
context %(context_name)s
ip access-list %(acl_name)s
10 deny icmp %(xpVpnSesHstIFRevMsk)s %(linux1RevMsk)s precedence 2 tos 0
exit
session name %(sess_name)s
 ip access-group out name %(acl_name)s
end
...
context %(context_name)s
ip access-list %(acl_name)s
10 permit igmp %(xpVpnSesHstIFRevMsk)s %(linux1RevMsk)s precedence 0 tos 1
20 permit icmp any any
exit
session name %(sess_name)s
 ip access-group out name %(acl_name)s
...
context %(context_name)s
ip access-list %(acl_name)s
10 deny igmp %(xpVpnSesHstIFRevMsk)s %(linux1RevMsk)s precedence 2 tos 0
20 permit icmp any any
exit
session name %(sess_name)s
 ip access-group out name %(acl_name)s
...
context %(context_name)s
ip access-list %(acl_name)s
10 permit ip %(xpVpnSesHstIFRevMsk)s %(linux1RevMsk)s precedence 0 tos 1
20 permit icmp any any
exit
session name %(sess_name)s
 ip access-group out name %(acl_name)s
...
context %(context_name)s
ip access-list %(acl_name)s
10 deny ip %(xpVpnSesHstIFRevMsk)s %(linux1RevMsk)s precedence 2 tos 0
20 permit icmp any any
exit
session name %(sess_name)s
 ip access-group out name %(acl_name)s
...
context %(context_name)s
ip access-list %(acl_name)s
10 permit tcp %(xpVpnSesHstIFRevMsk)s %(linux1RevMsk)s precedence 0 tos 1
20 permit icmp any any
exit
session name %(sess_name)s
 ip access-group out name %(acl_name)s
...
context %(context_name)s
ip access-list %(acl_name)s
10 deny tcp %(xpVpnSesHstIFRevMsk)s %(linux1RevMsk)s precedence 2 tos 0
20 permit icmp any any
exit
session name %(sess_name)s
 ip access-group out name %(acl_name)s
...
context %(context_name)s
ip access-list %(acl_name)s
10 permit udp %(xpVpnSesHstIFRevMsk)s %(linux1RevMsk)s precedence 0 tos 1
20 perrmit icmp any any
exit
session name %(sess_name)s
 ip access-group out name %(acl_name)s
end
...
context %(context_name)s
ip access-list %(acl_name)s
10 deny udp %(xpVpnSesHstIFRevMsk)s %(linux1RevMsk)s precedence 2 tos 0
20 permit icmp any any
exit
session name %(sess_name)s
 ip access-group out name %(acl_name)s
...
script_var['deny_out_tcp_port_options'] = """
context %(context_name)s
ip access-list %(acl_name)s
10 deny tcp %(xpVpnNwRevMsk)s %(linux1RevMsk)s precedence 1 tos 2
20 permit icmp any any
exit
exit
...
""" %script_var
#########################################################################
script_var['permit_in_tcp_port_options'] = """
context %(context_name)s
ip access-list %(acl_name)s
10 permit tcp %(xpVpnNwRevMsk)s %(linux1RevMsk)s precedence 2 tos 0
20 permit icmp any any
...
DEFAULT User-Name =~ "1650[0-9]*@stoke1",Auth-Type := EAP,EAP-Type := SIM
        ...
        Stoke-ACL-In = %(acl_name)s,
        Stoke-ACL-Out = %(acl_name)s,
