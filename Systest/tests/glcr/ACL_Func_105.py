...
DESCRIPTION: Verify ACL functionality for UDP traffic through port when inbound and outbound ACLs applied to port [Deny for inbound and Permit for outbound]
TEST PLAN: ACL Test plans
TEST CASES:ACL_FUNC_105.py

HOW TO RUN:python2.5 ACL_FUNC_105
...
class test_ACL_FUNC_105(test_case):
    myLog = getLogger()
    def setUp(self):
