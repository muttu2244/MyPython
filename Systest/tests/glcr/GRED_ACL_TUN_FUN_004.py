...
DESCRIPTION:To Verify SSX drops all IKE functionality packets when DENY UDP is applied to port  
TEST PLAN: ACL Test plans
TEST CASES:GRED_ACL_TUN_FUN_004.py

HOW TO RUN:python2.5 GRED_ACL_TUN_FUN_004
...
class test_GRED_ACL_TUN_FUN_004(test_case):
    myLog = getLogger()
    def setUp(self):
	...
	output_dut = check_tunnel_state(self.ssx ,tunnel = script_var['tunnel_name'])
        self.failIfEqual(output_dut,True , "Tunnels must Go Down")
    ...
    def test_GRED_ACL_TUN_FUN_004(self):
...
if __name__ == '__main__':
	...
	tt_faketest_2(testcase_id=1942, build_name='test_GRED_ACL_TUN_FUN_004',testplan_id=14,status=2,product_id=54,environment_id=12,manager_id=1217,version='6.0',tester=1217,build=None,run=None,testcase_run=None)
