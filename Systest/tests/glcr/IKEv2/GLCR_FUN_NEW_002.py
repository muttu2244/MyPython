...
TEST CASE: GLCR_FUN_NEW_002
HOW TO RUN: python2.5 GLCR_FUN_NEW_002.py
...
class test_GLCR_FUN_NEW_002(test_case):
    myLog = getLogger()
    ...
    def test_GLCR_FUN_NEW_002(self):
	...
	self.ssx.config_from_string(script_var1['GLCR_FUN_NEW_002'])
...
if __name__ == '__main__':
        ...
        log = buildLogger("GLCR_FUN_NEW_002.log", debug=True,console=True)
        suite = test_suite()
        suite.addTest(test_GLCR_FUN_NEW_002)
