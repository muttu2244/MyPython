...
DESCRIPTION: Verify ACL functionality for TCP traffic through port when inbound and outbound ACLs applied to port [ permit inbound and Permit for outbound]
TEST PLAN: ACL Test plans
TEST CASES:ACL_FUNC_102.py

HOW TO RUN:python2.5 ACL_FUNC_102
...
class test_ACL_FUNC_102(test_case):
    myLog = getLogger()
    def setUp(self):
