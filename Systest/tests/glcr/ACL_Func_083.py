...
DESCRIPTION: Verify ACL functionality for IGMP traffic through session when inbound and outbound ACLs applied to session [Deny for inbound and Deny for outbound] 
TEST PLAN: ACL Test plans
TEST CASES:ACL_Func_083.py

HOW TO RUN:python2.5 ACL_Func_083
...
class test_ACL_Func_083(test_case):
    myLog = getLogger()
    def setUp(self):
