...
TEST CASES:ACL_Func_131.py

HOW TO RUN:python2.5 ACL_Func_131
...
class test_ACL_Func_131(test_case):
    myLog = getLogger()
    def setUp(self):
	...
	self.linux.cmd("!sudo ping %s -I %s -c 2"%(script_var['linux1'], script_var['xpVpnHstIp']))
        ...
        # Push SSX config
        self.ssx.config_from_string(script_var['deny_igmp_in_options'])
