...
DESCRIPTION:To Verify ACL functionality for TCP traffic through tunnel when ACL bound to Tunnel(Permit/Deny)   
TEST PLAN: ACL Test plans
TEST CASES:GRED_ACL_TUN_FUN_003.py

HOW TO RUN:python2.5 GRED_ACL_TUN_FUN_003
...
class test_GRED_ACL_TUN_FUN_003(test_case):
    myLog = getLogger()
    def setUp(self):
    ...
    def test_GRED_ACL_TUN_FUN_003(self):
...
if __name__ == '__main__':
	...
	tt_faketest_2(testcase_id=1941, build_name='test_GRED_ACL_TUN_FUN_003',testplan_id=14,status=2,product_id=54,environment_id=12,manager_id=1217,version='6.0',tester=1217,build=None,run=None,testcase_run=None)	
