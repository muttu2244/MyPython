...
DESCRIPTION:To Verify SSX performs DPD transactions successfully when PERMIT UDP is applied to port  
TEST PLAN: ACL Test plans
TEST CASES:GRED_ACL_TUN_FUN_007.py

HOW TO RUN:python2.5 GRED_ACL_TUN_FUN_007
...
class test_GRED_ACL_TUN_FUN_007(test_case):
    myLog = getLogger()
    def setUp(self):
    ...
    def test_GRED_ACL_TUN_FUN_007(self):
