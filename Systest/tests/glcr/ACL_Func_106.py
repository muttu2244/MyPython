...
DESCRIPTION: Verify ACL functionality for UDP traffic through port when inbound and outbound ACLs applied to port [ permit inbound and Permit for outbound]
TEST PLAN: ACL Test plans
TEST CASES:ACL_FUNC_106.py

HOW TO RUN:python2.5 ACL_FUNC_106
...
class test_ACL_FUNC_106(test_case):
    myLog = getLogger()
    def setUp(self):
