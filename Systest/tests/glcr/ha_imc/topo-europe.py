...
#Device info
ssx_ini = Initiator = {'ip_addr':'europe-mc-con','user_name': 'joe@local','password':'joe', 'hostname':'europe'}
ssx_resp = Responder = {'ip_addr':'qa-3k-1','user_name': 'joe@local','password':'joe', 'hostname':'qa-3k-1'}
cisco1 = cisco =  {'ip_addr':'qa-c6509-4-con','user_name':'stoke','password' : 'stoke','hostname':'qac6509' }
...
p_active_ssx_cisco_slot2 = ["2/0","12/3"] # Logical slot 100 and 101 will be dependent on this port number
p_active_ssx_cisco_slot3 = ["3/0","12/1"] # Logical slot 100 and 101 will be dependent on this port number
p_standby_ssx_cisco_slot2 = ["4/0","12/2"]
p_standby_ssx_cisco_slot3 = ["4/1","9/3"]
p_to_rad_active_ssx_cisco_slot2 = ["2/1","9/4"]
p_to_rad_standby_ssx_cisco_slot2 = ["3/1","9/1"]
p_to_rad_active_ssx_cisco_slot3 = ["2/1","9/4"]
p_to_rad_standby_ssx_cisco_slot3 =  ["3/1","9/1"]

#Connectivity for Initiator
p_ini_cisco_slot2 = ["2/0","5/37"] #This var will be responsible for the logical slot for initiator
p_ini_cisco_slot3 = ["3/0","5/38"]

p_cisco_host2 = ["2/7","eth1"]

#=====If you are not using IXIA ports, please leave it
p_cisco_ixia_service = ["9/4","9/4"]
p_cisco_ixia_transport = ["9/1","9/1"]
...
dummy_ports = ["2/1", "3/1"] # ["Second card",  "Third card"]
