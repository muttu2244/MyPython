...
DESCRIPTION: To Check for Port counters after IMC switchover
TEST MATRIX: 4.6B2_HA-IMC.xls
TEST CASE  : HA_IMC_CLI_009
TOPOLOGY   : GLC-R Setup 

HOW TO RUN : python2.5 HA_IMC_CLI_009.py
...
class test_HA_IMC_CLI_009(test_case):
    myLog = getLogger()
	...
	while(1):
        ...
        out = self.Resp.cmd("show port count")
        ...
        out = self.Resp.cmd("show port count")
        self.myLog.output("\n\n ########### show port counters after IMC switchover ")
        self.myLog.output("%s ########### \n\n"%out)
...
if __name__ == '__main__':
        ...
        suite = test_suite()
        suite.addTest(test_HA_IMC_CLI_009)
