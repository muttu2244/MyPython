...
DESCRIPTION: Establish large number of tunnels, Initiate clear session all and immediately switch over
TEST MATRIX: 4.6B2_HA-IMC.xls
TEST CASE  : HA_IP_28
TOPOLOGY   : GLC-R Setup 

HOW TO RUN : python2.5 HA_IP_28.py
...
class test_HA_IP_28(test_case):
	...
	while(1):
        ...
        self.myLog.info("\n\n######## execute the command \"clear tunnel all\" \n")
