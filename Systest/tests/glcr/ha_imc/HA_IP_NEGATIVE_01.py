...
TEST CASE  : HA_IP_NEGATIVE_01
TOPOLOGY   : GLC-R Setup 

HOW TO RUN : python2.5 HA_IP_NEGATIVE_01.py
...
class test_HA_IP_NEGATIVE_01(test_case):
    myLog = getLogger()
    ...
    def test_HA_IP_NEGATIVE_01(self):
        Card_Reset = 0
        Card_Restart = 0
        IMC_Switch = 0
...
if __name__ == '__main__':
        ...
        suite = test_suite()
        suite.addTest(test_HA_IP_NEGATIVE_01)
