...
DESCRIPTION: Start establishing tunnels. Switch over IMC. 

TEST MATRIX: 4.6B2_HA-IMC.xls
TEST CASE  : HA_IP_026
TOPOLOGY   : GLC-R Setup 

HOW TO RUN : python2.5 HA_IP_026.py
...
class test_HA_IP_026(test_case):
    myLog = getLogger()
