...
TEST CASE  : HA_IMC_CLI_010
TOPOLOGY   : GLC-R Setup 

HOW TO RUN : python2.5 HA_IMC_CLI_010.py
...
class test_HA_IMC_CLI_010(test_case):
    myLog = getLogger()
...
if __name__ == '__main__':
        ...
        suite = test_suite()
        suite.addTest(test_HA_IMC_CLI_010)
