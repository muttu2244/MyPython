...
DESCRIPTION: Produce a coredump frequently on non restartable process on GLC
TEST MATRIX: 4.6B2_HA-IMC.xls
TEST CASE  : HA_GLC_010
TOPOLOGY   : GLC-R Setup 

HOW TO RUN : python2.5 HA_GLC_010.py
...
class test_HA_GLC_010(test_case):
    myLog = getLogger()
