...
print "arp arpa"
print "arp refresh"
print "ip address %s"%haimc_var['active_slot2_ip/mask']
print "exit"
print "interface transback"
print "arp arpa"
print "arp refresh"
print "ip address %s"%haimc_var['standby_4slot2_ip/mask']
print "exit"
print "interface service"
print "arp arpa"
print "arp refresh"
print "ip address %s"%haimc_var['rad_intf_4slot2_ip/mask']
print "exit"
print "interface serback"
print "arp arpa"
print "arp refresh"
print "ip address %s"%haimc_var['bkp_rad_intf_4slot2_ip/mask']
print "exit"
...
print "exit"
print "exit"
print "rtr %s"%haimc_var['rtr_id1']
print "type echo protocol ipicmpecho %s source %s"%(haimc_var['cisco_active_slot2_ip'],haimc_var['active_slot2_ip'])
print "exit"
print "rtr schedule %s"%haimc_var['rtr_id1']
...
if routeOption == 'y':
	print "ip route %s %s track %s"%(haimc_var['routes_to_ini_ip_slot2'], haimc_var['cisco_active_slot2_ip'],haimc_var['rtr_id1']) 
	print "ip route %s %s admin-distance 20"%(haimc_var['routes_to_ini_ip_slot2'], haimc_var['cisco_standby_4slot2_ip'])
	print "ip route %s %s"%(haimc_var['cisco_ssx_slot3_ses_traffic_route'], haimc_var['cisco_rad_intf_4slot2_ip'])
	print "ip route %s %s admin-distance 20"%(haimc_var['cisco_ssx_slot3_ses_traffic_route'], haimc_var['cisco_bkp_rad_intf_4slot2_ip'])
	print "ip route %s %s track %s"%(haimc_var['dummy_intf_routes_slot2'], haimc_var['cisco_active_slot2_ip'],haimc_var['rtr_id1'])
	print "ip route %s %s admin-distance 20"%(haimc_var['dummy_intf_routes_slot2'], haimc_var['cisco_standby_4slot2_ip'])
#print "ip route %s/32 %s"%(remoteIp, nextHop)
print "exit"

# Session home config
print "session-home slot 100 loopback interface lpbk-1 %s"%haimc_var['context1']
print "ipsec session context name %s"%haimc_var['context1']
print "ipsec policy ikev2 phase1 name ikev2_phase1"
print "ipsec policy ikev2 phase2 name ikev2_phase2"
print "exit"
d = d + 1
...
for i in xrange(max_tun):
	...
	print "context %s"%haimc_var['context1']
        ...
        print "exit"
	print "exit"
        print "tunnel %s_tun%d type ipsec protocol ip44 context %s"%(haimc_var['context1'], i, haimc_var['context1'])
        print "enable"
...
print "port ethernet %s dot1q"%haimc_var['port_ssx_active_4slot2']
print "vlan %s"%haimc_var['vlan4slot2']
print "bind interface transport %s"%haimc_var['context1']
print "exit"
print "service ipsec"
print "exit"
print "enable"
print "exit"
print "port ethernet %s dot1q"%haimc_var['port_ssx_rad_intf_4slot2']
print "vlan %s"%haimc_var['service_vlan4slot2']
print "bind interface service %s"%haimc_var['context1']
print "exit"
print "exit"
print "enable"
print "exit"
print "port ethernet %s dot1q"%haimc_var['port_ssx_standby_4slot2']
print "vlan %s"%haimc_var['standby_vlan4slot2']
print "bind interface transback %s"%haimc_var['context1']
print "exit"
print "service ipsec"
print "exit"
print "enable"
print "exit"
print "port ethernet %s dot1q"%haimc_var['port_ssx_bkp_rad_intf_4slot2']
print "vlan %s"%haimc_var['serback_vlan4slot2']
print "bind interface serback %s"%haimc_var['context1']
print "exit"
print "exit"
print "enable"
print "exit"
