...
TEST CASES:GRED_ACL_TUN_FUN_005.py

HOW TO RUN:python2.5 GRED_ACL_TUN_FUN_005
...
class test_GRED_ACL_TUN_FUN_005(test_case):
    myLog = getLogger()
    def setUp(self):
	...
	#self.linux.ping_xpress_vpn(script_var['xpVpnHstIp'],script_var['linux1'],"500","2")
	...
	#ping after acl removed
        op_ping = self.linux.ping_xpress_vpn(script_var['xpVpnHstIp'],script_var['tnLpBkIp'],"500","4")
        self.failIfEqual(op_ping,False,"Ping through tunnel failed after Reload")
	...
	#ping after acl removed
        op_ping = self.linux.ping_xpress_vpn(script_var['xpVpnHstIp'],script_var['cisco_service_slot2_ip'],"500","4")
        self.failIfEqual(op_ping,False,"Ping through tunnel failed after Switchback")
