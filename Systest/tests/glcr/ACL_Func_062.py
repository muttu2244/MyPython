...
DESCRIPTION:Verify ACL functionality for ICMP traffic through tunnel when inbound and outbound ACLs applied to tunnel bound to Tunnel [Permit for inbound and Permit for outbound]  
TEST PLAN: ACL Test plans
TEST CASES:test_ACL_Func_062.py

HOW TO RUN:python2.5 test_ACL_Func_062
...
class test_ACL_Func_062(test_case):
    myLog = getLogger()
    def setUp(self):
	...
	#Removing the Acl applied
        ...
        # Push ACL config
        self.ssx.config_from_string(script_var['permit_icmp_out'])
