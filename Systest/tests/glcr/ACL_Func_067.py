...
DESCRIPTION:Verify ACL functionality for IGMP traffic through tunnel when inbound and outbound ACLs applied to tunnel bound to Tunnel [deny for inbound and deny for outbound]  
TEST PLAN: ACL Test plans
TEST CASES:ACL_Func_067.py

HOW TO RUN:python2.5 ACL_Func_067
...
class test_ACL_Func_067(test_case):
    myLog = getLogger()
    def setUp(self):
