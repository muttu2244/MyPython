...
TEST CASES:ACL_Func_124.py

HOW TO RUN:python2.5 ACL_Func_124
...
class test_ACL_Func_124(test_case):
    myLog = getLogger()
    def setUp(self):
	...
	self.ssx.config_from_string(script_var['permit_icmp_sess_out_options'])
