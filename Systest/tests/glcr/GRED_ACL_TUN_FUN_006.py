...
DESCRIPTION:To Verify SSX performs phase 2 rekeys successfully when PERMIT UDP is applied to port  
TEST PLAN: ACL Test plans
TEST CASES:GRED_ACL_TUN_FUN_006.py

HOW TO RUN:python2.5 GRED_ACL_TUN_FUN_006
...
class test_GRED_ACL_TUN_FUN_006(test_case):
    myLog = getLogger()
    def setUp(self):
    ...
    def test_GRED_ACL_TUN_FUN_006(self):
...
if __name__ == '__main__':
	...
	tt_faketest(testrun_id=8, testcase_id=1943,build_id=2,environment_id=12,status=2)
