...
DESCRIPTION: Verify ACL functionality for UDP traffic through session when inbound and outbound ACLs applied to session [Deny for inbound and Permit for outbound] 
TEST PLAN: ACL Test plans
TEST CASES:ACL_Func_089.py

HOW TO RUN:python2.5 ACL_Func_089
...
class test_ACL_Func_089(test_case):
    myLog = getLogger()
    def setUp(self):
	...
	# Push ACL config
        self.ssx.config_from_string(script_var['deny_udp_sess_in'])
