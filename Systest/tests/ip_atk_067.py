...
DESCRIPTION:Send ICMP ECHO Request packet to IP address of SSX
TEST PLAN:IP-ATTACK test plans
TEST CASEID:ip_atk_067
...
HOW TO RUN:python2.5 ip_atk_067.py
...
class test_ip_atk_067(test_case):
    myLog = getLogger()	
	...
	#Send ICMP ECHO Request packet to IP address of SSX
	out = self.linux1.cmd("sudo /usr/bin/nmap -sP %s  & "%(script_var['ssx_ip_addr']))
	time.sleep(30)
