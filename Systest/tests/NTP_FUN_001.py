...
HOW TO RUN:python2.5 NTP_FUN_001.py
...
class test_NTP_FUN_001(test_case):
    myLog = getLogger()
	...
	self.ssx.config_from_string(script_var['NTP_FUN_001'])
