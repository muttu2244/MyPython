...
DESCRIPTION: Verify ntp client functionality with option 'prefer' when using multilple peers
TEST PLAN:NTP FUN Test plans
TEST CASES: NTP_FUN_003
...
HOW TO RUN: python2.5 NTP_FUN_003.py
...
class test_NTP_FUN_003(test_case):
    myLog = getLogger()
	...
	# Push NTP configuration on NTP client
        ...
        self.ssx.config_from_string(script_var['NTP_FUN_003'])
...
if __name__ == '__main__':
	...
	suite = test_suite()
	suite.addTest(test_NTP_FUN_003)
