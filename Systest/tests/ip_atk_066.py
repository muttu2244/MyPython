...
DESCRIPTION:TCP Stealth FIN Scan 
TEST PLAN:IP-ATTACK test plans
TEST CASEID:ip_atk_066
...
HOW TO RUN:python2.5 ip_atk_066.py
...
class test_ip_atk_066(test_case):
    myLog = getLogger()	
	...
	#TCP Stealth FIN Scan 
	out = self.linux1.cmd("sudo /usr/bin/nmap -sF %s  & "%(script_var['ssx_ip_addr']))
	time.sleep(30)
