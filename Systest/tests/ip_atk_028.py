...
DESCRIPTION:Spoofed broadcast ping messages to flood to SSX
TEST PLAN:IP-ATTACK test plans
TEST CASEID:ip_atk_028
...
HOW TO RUN:python2.5 ip_atk_028.py
...
class test_ip_atk_028(test_case):
    myLog = getLogger()	
	...
	self.ssx.config_from_string(script_var['DOS_FUN_028'])
	...
	out = self.linux1.cmd("sudo ./smurf %s smurf.c 90000 1 1024 "%(script_var['ssx_ip_addr']),timeout = 350)

	#killing hping process
        self.linux1.cmd("sudo pkill -9 smurf") 
