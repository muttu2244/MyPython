...
DESCRIPTION: Confirm OSPF re-distribute route learn from Static and Connected
TEST PLAN:
TEST CASES: NTT_4_1_20

HOW TO RUN: python2.5 NTT_4_1_20.py
...
class test_NTT_4_1_20(test_case):
    myLog = getLogger()
...
if __name__ == '__main__':
        ...
        log = buildLogger("NTT_4_1_20.log", debug=True,console=True)
        suite = test_suite()
        suite.addTest(test_NTT_4_1_20)
