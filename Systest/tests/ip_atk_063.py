...
HOW TO RUN:python2.5 ip_atk_063.py
...
class test_ip_atk_063(test_case):
    myLog = getLogger()	
	...
	out = self.linux1.cmd("sudo /usr/bin/nmap -sT %s  & "%(script_var['ssx_ip_addr']))
	time.sleep(30)
