...
HOW TO RUN : python ACL_FUN_011_PERMITTCP.py 
...
class test_SAN_ACL_PERMITTCP(test_case):
    myLog = getLogger()
    ...
    def tearDown(self):
        ...
        self.ssx.close()
	self.linux.close()
    def test_SAN_ACL_PERMITTCP(self):
	...
	# Push SSX config
	self.ssx.config_from_string(script_var['SAN_ACL_011-PERMITTCP'])
