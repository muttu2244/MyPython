...
HOW TO RUN : python ACL_FUN_012_DENYIGMP.py
"""
...
class test_SAN_ACL_DENYIGMP(test_case):
    myLog = getLogger()
    ...
    def tearDown(self):
        ...
        self.ssx.close()
	self.linux.close()
    def test_SAN_ACL_DENYIGMP(self):
	...
	# Push SSX config
	self.ssx.config_from_string(script_var['SAN_ACL_11-DENYIGMP'])
