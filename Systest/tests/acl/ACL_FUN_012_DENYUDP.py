...
class test_SAN_ACL_DENYUDP(test_case):
    myLog = getLogger()
	...
	# Push SSX config
        self.ssx.config_from_string(script_var['SAN_ACL_011-DENYUDP'])
