...
HOW TO RUN : python ACL_FUN_015.py
...
class test_SAN_ACL_015(test_case):
    myLog = getLogger()
	...
	# Push SSX config
	self.ssx.config_from_string(script_var['SAN_ACL_014'])
	...
	# Push SSX config
        self.ssx.config_from_string(script_var['SAN_ACL_014-1'])
