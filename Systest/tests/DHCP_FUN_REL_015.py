...
DESCRIPTION:To verify SSX (relay agent)does contain  relay information option  when enabled. 
TEST PLAN: DHCP Test plans
TEST CASE ID: DHCP-FUN-REL-015
...
TOPOLOGY DIAGRAM:
	...
	--------------------------------------------------------------------------------
       ...
       |                     ETH1                                   Port 3/0		|
         --------------------------------------------------------------------------------
HOW TO RUN:python2.5 DHCP-FUN-REL-015.py
...
class test_DHCP_FUN_015(test_case):
    myLog = getLogger()
...
#        self.ssx.clear_health_stats()
	...
	# Push SSX config
        self.ssx.config_from_string(script_var['DHCP_FUN_015'])
	 ...
	 #configure ip interface on linux machine
        ...
        #Capturing the packets  on server side.
        ...
        self.failUnless("Agent Circuit ID:" in outstr)
