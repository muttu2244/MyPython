...
DESCRIPTION:Send Flood of SYN packets with spoofed source IP to SSX
TEST PLAN:IP-ATTACK test plans
TEST CASEID:ip_atk_085
...
HOW TO RUN:python2.5 ip_atk_085.py
...
class test_ip_atk_085(test_case):
    myLog = getLogger()	
   ...
   #     self.ssx.clear_config()
	...
	self.linux1.cmd("sudo /usr/sbin/hping -S -p 22 %s -a 30.1.1.1 --flood &"%script_var['ssx_ip_addr'])
        time.sleep(40)
