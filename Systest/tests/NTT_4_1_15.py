...
DESCRIPTION: Define interface which belong to multiple area, and confirm it is ABR by executing "show ip ospf" 
TEST PLAN:
TEST CASES: NTT_4_1_15

HOW TO RUN: python2.5 NTT_4_1_15.py
...
class test_NTT_4_1_15(test_case):
    myLog = getLogger()
...
if __name__ == '__main__':
        ...
        log = buildLogger("NTT_4_1_15.log", debug=True,console=True)
        suite = test_suite()
        suite.addTest(test_NTT_4_1_15)
