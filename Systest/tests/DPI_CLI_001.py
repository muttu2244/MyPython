...
DESCRIPTION: configure DPI filter

TEST PLAN: DPI Test Plan
TEST CASES: DPI_CFG_01	 

TOPOLOGY DIAGRAM:
                      -NA- 

How to run: "python2.5 DPI-CLI-001.py"
...
class test_DPI_CLI_001(test_case):
    myLog = getLogger()
...
if __name__ == '__main__':
    ...
    suite = test_suite()
    suite.addTest(test_DPI_CLI_001)
