...
DESCRIPTION:Send TCP packets with URG bit set to SSX.

TEST PLAN:IP-ATTACK test plans
TEST CASE ID:ip_atk_035
...
HOW TO RUN:python2.5 ip_atk_035.py
...
class test_ip_atk_035(test_case):
    myLog = getLogger()	
	...
	out = self.linux1.cmd("sudo /usr/sbin/hping -U %s -p 23  --flood &"%(script_var['ssx_ip_addr']))
	time.sleep(30)
