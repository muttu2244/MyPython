...
DESCRIPTION: Confirm neighbor become UP and route is added when direct link is UP.
TEST PLAN:
TEST CASES: NTT_4_1_23

HOW TO RUN: python2.5 NTT_4_1_23.py
...
class test_NTT_4_1_23(test_case):
    myLog = getLogger()
    ...
    def test_NTT_4_1_23(self):

        self.myLog.output("==================Starting The Test====================")
	
        # Push SSX config
	self.ssx1.config_from_string(route_var['NTT_4_1_23'])
...
if __name__ == '__main__':
        ...
        log = buildLogger("NTT_4_1_23.log", debug=True,console=True)
        suite = test_suite()
        suite.addTest(test_NTT_4_1_23)
