...
DESCRIPTION: Confirm neighbor become Down and route is deleted when direct link is DOWN.
TEST PLAN:
TEST CASES: NTT_4_1_22

HOW TO RUN: python2.5 NTT_4_1_22.py
...
class test_NTT_4_1_22(test_case):
    myLog = getLogger()
    ...
    def test_NTT_4_1_22(self):

        self.myLog.output("==================Starting The Test====================")
	
        # Push SSX config
	self.ssx1.config_from_string(route_var['NTT_4_1_22'])
...
if __name__ == '__main__':
        ...
        log = buildLogger("NTT_4_1_22.log", debug=True,console=True)
        suite = test_suite()
        suite.addTest(test_NTT_4_1_22)
