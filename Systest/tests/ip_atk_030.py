...
DESCRIPTION:ICMP spoofed unreachable -- click attack
TEST PLAN:IP-ATTACK test plans
TEST CASEID:ip_atk_030
...
HOW TO RUN:python2.5 ip_atk_030.py
...
class test_ip_atk_030(test_case):
    myLog = getLogger()	
	...
	out = self.linux1.cmd("sudo /usr/sbin/hping -1 -a 30.1.1.1 -p 23 --flood &")
        time.sleep(30)
