...
def threshold_fetch_api(zauth, data):
	url = "http://%s/services/thresholds.fetch.php" % (INTERNAL_URL[random.randrange(0,SERVERS)] )
	return curl_web_req(zauth, url, data)

def threshold_update_api(zauth,data):
	url = "http://%s/services/thresholds.update.php" % (INTERNAL_URL[random.randrange(0,SERVERS)]) 
	return curl_web_req(zauth, url, data)

def user_credibility_get(zauth, data):
	url = "http://%s/services/user.credibility.get.php" % (INTERNAL_URL[random.randrange(0,SERVERS)] )
	time.sleep(1)
	return curl_web_req(zauth, url, data)

def user_reputation_update(zauth, data):
	url = "http://%s/services/user.reputation.update.php"  % (INTERNAL_URL[random.randrange(0,SERVERS)] )
	time.sleep(1)
	return curl_web_req(zauth, url, data)
...
def user_blob_golden_update(zauth,data):
	url = "http://%s/services/user.blob.golden.update.php" % (INTERNAL_URL[random.randrange(0,SERVERS)] )
	return curl_web_req(zauth, url, data)


def user_history_update(zauth, data):
	url = "http://%s/services/user.history.update.php"  % (INTERNAL_URL[random.randrange(0,SERVERS)] )
	return curl_web_req(zauth , url , data)


def fraud_update(zauth,data):
	url = "http://%s/services/fraud.update.php"  % (INTERNAL_URL[random.randrange(0,SERVERS)] )
        return curl_web_req(zauth , url , data)


def archive_update_API(zauth, data):
	url = "http://%s/services/archive.queue.update.php"  % (INTERNAL_URL[random.randrange(0,SERVERS)] )
	return curl_web_req(zauth , url ,data)

def dau_update(zauth,data):
	url = "http://%s/services/dau.queue.update.php" % (INTERNAL_URL[random.randrange(0,SERVERS)] )
        return curl_web_req(zauth , url ,data)


def archive_queue_fetch(zauth,data):
	 url = "http://%s/services/archive.queue.fetch.php" % (INTERNAL_URL[random.randrange(0,SERVERS)] )
	 time.sleep(1)
	 return curl_web_req(zauth, url,data)

def dau_queue_fetch(zauth,data):
	 url = "http://%s/services/dau.queue.fetch.php" % (INTERNAL_URL[random.randrange(0,SERVERS)] )
         time.sleep(1)
         return curl_web_req(zauth, url,data)


def user_blob_archive(zauth,data):
	 url = "http://%s/services/user.blob.archive.php"  % (INTERNAL_URL[random.randrange(0,SERVERS)] )
         return curl_web_req(zauth, url,data)


def payments_append(zauth,data):
	url = "http://%s/services/user.payments.meta.append.php" % (INTERNAL_URL[random.randrange(0,SERVERS)] )
	return curl_web_req(zauth, url,data)

def  user_payments_meta_get(zauth,data):
	url = "http://%s/services/user.payments.meta.get.php" % (INTERNAL_URL[random.randrange(0,SERVERS)] )
        return curl_web_req(zauth, url,data)

def user_blob_revert(zauth,data):
	 url = "http://%s/services/user.blob.revert.php"  % (INTERNAL_URL[random.randrange(0,SERVERS)] )
         return curl_web_req(zauth, url,data)

def fraud_queue_update(zauth,data):
	url = "http://%s/services/fraud.queue.update.php" % (INTERNAL_URL[random.randrange(0,SERVERS)] )
        return curl_web_req(zauth, url,data)

def fraud_queue_fetch(zauth,data):
	url = "http://%s/services/fraud.queue.fetch.php"  % (INTERNAL_URL[random.randrange(0,SERVERS)] )
	time.sleep(1)
        return curl_web_req(zauth, url,data)
